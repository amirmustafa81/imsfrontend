      ...
      <div className="container-fluid">
        ...
        <div className="card border-0 shadow-sm">
          <div className="card-body p-4">
            <h1 className="h3 mb-2">Issue / Return</h1>
            <p className="text-secondary mb-4">Record issue vouchers, recipient acknowledgement, returns, and manual approval references.</p>
